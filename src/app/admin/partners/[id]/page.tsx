        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 space-y-6">
            <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-6">
              <h3 className="text-xl font-semibold text-[#f5f5f5] mb-2">Final Review</h3>
              <p className="text-[#9ca3af] text-sm mb-6">Verify all documents and details before making a decision.</p>
      ...
      <AnimatePresence>
        {showRejectModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-[#0f0f0f]/80 backdrop-blur-sm">
            ...
            >
              <h3 className="text-xl font-semibold text-[#f5f5f5] mb-2 text-center">Reject Application?</h3>
              <p className="text-[#9ca3af] text-center text-sm mb-6">Please provide a reason for the partner to correct.</p>
...
const DocumentCard = ({ label, url }: { label: string, url: string }) => (
  <div className="relative group overflow-hidden rounded-xl border border-[#2a2a2a] bg-[#0f0f0f]">
    <div className="aspect-[3/2] relative">
      ...
      <a 
        ...
        target="_blank" 
        rel="noopener noreferrer"
        className="absolute top-2 right-2 p-1.5 bg-[#1a1a1a]/80 backdrop-blur-md rounded-lg text-[#f5f5f5] opacity-0 group-hover:opacity-100 transition-all hover:bg-[#2a2a2a]"
      >
...
const EmptySection = ({ message }: { message: string }) => (
  <div className="flex flex-col items-center justify-center py-10 bg-[#0f0f0f] rounded-xl border border-dashed border-[#2a2a2a]">
